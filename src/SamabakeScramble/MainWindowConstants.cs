namespace InitSetting
{
    public partial class MainWindow
    {
        ...
        private const string ExecutableGame = "SamabakeScramble.exe";
        private const string ExecutableVR = "AicomiVR\\AicomiVR.exe";

        private const string ManualUrlGame = "https://download.illgames.jp/product/SamabakeScramble/manual/en.php";
